package com.vishal.linkedInProject.connectionsService.repository;
...
public interface PersonRepository extends Neo4jRepository<Person,Long> {
    ...
    @Query("MATCH (personA:Person {userId: $userId})-[:CONNECTED_TO*2]-(personC) " +
            "WHERE NOT (personA)-[:CONNECTED_TO]-(personC) AND personC.userId <> $userId " +
